    ...
    (function (widgets) {
        ...
        (function (directives) {
            ...
            <ul class="pager" data-id="pager">\
                <li ng-if="indexVM.page <= 1" class="disabled arrow"><a href="">&lsaquo;</a></li>\
                <li ng-if="indexVM.page > 1" class="arrow"><a href="" ng-click="indexVM.page=indexVM.page - 1">&lsaquo;</a></li>\
                <li class="page-count">Page {{indexVM.page}} of {{indexVM.pageCount}}</li>\
                <li ng-if="indexVM.pageCount <= indexVM.page" class="disabled arrow"><a href="">&rsaquo;</a></li>\
                <li ng-if="indexVM.pageCount > indexVM.page" class="arrow"><a href="" ng-click="indexVM.page=indexVM.page + 1">&rsaquo;</a></li>\
            </ul>\
';
                    return directive;
                }
